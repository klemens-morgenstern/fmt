...
#ifndef BOOST_FMT_CT_STRING_HPP
#define BOOST_FMT_CT_STRING_HPP

#if defined(__cpp_nontype_template_args)


#define BOOST_FMT_HAS_NTTP_STRING 1

#include <algorithm>
#include <limits>
#include <boost/core/detail/string_view.hpp>

namespace boost::fmt::ct
{
...
struct string
{
  ...
  constexpr string(core::basic_string_view<Char> sv)
  {
  ...
  constexpr static std::size_t capacity() {return Size - 1; }
    ...
    constexpr core::basic_string_view< char_type >
  view() const
  {
    return { raw_string };
  }
  constexpr operator core::basic_string_view< char_type >() const { return view(); }
  ...
  constexpr auto
  operator==(core::basic_string_view< char_type > sv) const
  {
    return view() == sv;
  }
